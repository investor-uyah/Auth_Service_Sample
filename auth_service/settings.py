...
import environ # Enables operations related to environment variables 
import os
...
SECRET_KEY = 'django-insecure-hf@l5#ccekbsenm*an&pl&(k&0)rvhp6cbrh)jn&$2ynki%y!z'
...
# Note that this project uses a postgres database from Supabase
